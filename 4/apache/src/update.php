...
if(isset($_POST["id"]) && !empty($_POST["id"])){
    ...
    if(empty($input_cost)){
        $cost_err = "Please enter the cost number.";     
    ...
    if(empty($name_err) && empty($cost_err) ){
        ...
        $sql = "UPDATE goods SET name=?, cost=? WHERE id=?";
         
        if($stmt = mysqli_prepare($link, $sql)){
            // Bind variables to the prepared statement as parameters
            mysqli_stmt_bind_param($stmt, "ssi", $param_name, $param_cost, $param_id);
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <p>Пожалуйста заполните форму для обновления записи о товаре.</p>
